  ...
  return (
      ...
      <div className='flex justify-between '>
       ...
       <img src={notificacion} alt="notificacion" className='w-8' />
        ...
        <Link>
           <h1 className='p-2 border-2 rounded-xl bg-yellow-500 ring-yellow-500 font-nunito'>100</h1>
        </Link>
